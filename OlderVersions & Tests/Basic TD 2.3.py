...
Towers.append(Tower(2))
Towers.append(Tower(3))
Towers.append(Tower(4))
    ...
    while run:
        ...
        for i in Towers:                                                        
            for event in pygame.event.get():
                #Making List but not saving? thus nothing to iterate over
                #For other frames
                #print(pygame.event.get())
                #Checking inputs in EventList
                #if i.image == 1:
                ...
                if event.type == QUIT:
                    ...
                    if event.key == K_q and i == 0:
                        i.ToggleBlue()
                        i.Blueprint()
                    if event.key == K_w and i.image == 1:
                        i.ToggleBlue()
                        i.Blueprint()       
                    if event.key == K_e and i.image == 2:     
                        i.ToggleBlue()
                        i.Blueprint()
                    if event.key == K_r and i.image == 3:
                        i.ToggleBlue()         
                        i.Blueprint()       
                    if event.key == K_t and i.image == 4:        
                        i.ToggleBlue() 
                        i.Blueprint()
